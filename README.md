...
Trying to complete all projects from [Martyr2’s Mega Project List](http://www.dreamincode.net/forums/topic/78802-martyr2s-mega-project-ideas-list/) in JavaScript/HTML5. Originally found [here](https://github.com/thekarangoel/Projects).
...
[**Find Cost of Tile to Cover W x H Floor**](https://github.com/jdllama/Projects/blob/master/tilecost.js) – Calculate the total cost of tile it would take to cover a floor plan of width and height, using a cost entered by the user.

**Mortgage Calculator** – Calculate the monthly payments of a fixed term mortgage over given Nth terms at a given interest rate. Also figure out how long it will take the user to pay back the loan.

**Change Return Program** – The user enters a cost and then the amount of money given. The program will figure out the change and the number of quarters, dimes, nickels, pennies needed for the change.

[**Binary to Decimal and Back Converter**](https://github.com/jdllama/Projects/blob/master/binarydecimal.js) – Develop a converter to convert a decimal number to binary or a binary number to its decimal equivalent.
...
[**Reverse a String**](https://github.com/jdllama/Projects/blob/master/reverse.js) – Enter a string and the program will reverse it and print it out.
